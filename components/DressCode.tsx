  ...
  return (
    <section className="w-full mb-10 sm:mb-14 animate-fade-up animate-delay-400">
      ...
      >
        ...
        >
          Дорогие гости, ваше присутствие — главный подарок для нас. Если вы хотите поздравить нас, мы будем благодарны за денежный вклад в наш семейный бюджет. От цветов, пожалуйста, воздержитесь — мы очень ценим ваше внимание и понимание.
        </p>
      </div>
    </section>
  );
